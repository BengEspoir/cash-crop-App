...
export function BuyerHelpHeader() {
  return (
...
export function BuyerHelpHero({ search, onSearchChange }) {
  return (
...
export function BuyerHelpTopics() {
  return (
...
export function BuyerFaqSection({ category, faqs, onCategoryChange }) {
  return (
    <BuyerPanel
...
export function BuyerGuidesSection() {
  return (
...
export function BuyerSupportTicketForm({ form, orders, setForm, onSubmit, isSubmitting }) {
  return (
    <BuyerPanel title="Submit a support ticket" className="scroll-mt-28" bodyClassName="p-6">
      <form id="support-ticket-form" onSubmit={onSubmit} className="grid gap-4">
        ...
        <div className="flex justify-end">
          <BuyerButton type="submit" variant="primary" disabled={isSubmitting}>
...
export function BuyerHelpSidebar({ tickets, isLoading, user }) {
  return (
