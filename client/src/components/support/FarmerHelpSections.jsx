...
export function FarmerHelpOverview() {
  return (
    <>
...
export function FarmerFaqSection() {
  return (
...
export function FarmerSupportTickets({
  form,
  setForm,
  onSubmit,
  isSubmitting,
  ...
  return (
    <FarmerPanel title="Support Tickets">
      <form onSubmit={onSubmit} className="mb-6 grid gap-4 rounded-xl border border-ink-100 bg-ink-50 p-5 md:grid-cols-2">
        ...
        <div className="md:col-span-2">
          <FarmerButton type="submit" icon={LifeBuoy} disabled={isSubmitting}>
