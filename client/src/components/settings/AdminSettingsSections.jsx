...
import { AdminCard, AdminIconTile } from "@/components/admin/AdminDesignSystem";
import { ProfilePhotoEditor } from "@/components/account/ProfilePhotoEditor";
import { Input } from "@/components/ui/input";

export function AdminProfileSettings({ user, adminName }) {
  return (
...
export function AdminSettingsHighlights() {
  return (
...
export function AdminOperationalSettings() {
  return (
