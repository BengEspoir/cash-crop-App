export const demoListings = [
  ...
  },
  {
    ...
    crop: "White Maize",
    quantity: "5,000 kg",
    quantityLabel: "5,000 kg available",
    ...
    deliveryWindow: "Ready within 6 days",
    summary: "Bulk white maize from northern growers suitable for milling and feed programs.",
    imageClass: "bg-[linear-gradient(135deg,#E6C96F,#F7EDD5)]",
    specs: [
      { label: "Moisture", value: "13%" },
      { label: "Packaging", value: "50 kg woven bags" },
  ...
  },
  {
    id: "plantain-ebolowa",
    crop: "Plantain",
    quantity: "1,200 bunches",
    quantityLabel: "1,200 bunches available",
    ...
    farmerId: "jean-ngum",
    grade: "Fresh market",
    deliveryWindow: "Ready within 2 days",
    summary: "Hand-harvested plantain bunches suitable for domestic retail distribution.",
    imageClass: "bg-[linear-gradient(135deg,#4E7D2E,#D4B74A)]",
    specs: [
      { label: "Ripeness", value: "Mature green" },
      { label: "Packaging", value: "Open bunch" },
      { label: "MOQ", value: "50 bunches" },
      { label: "Settlement", value: "Protected" },
    ],
  },
  {
    id: "palm-oil-eseka",
    crop: "Palm Oil",
    quantity: "500 litres",
    quantityLabel: "500 litres available",
    ...
    farmerId: "paul-meka",
    grade: "Artisanal red",
    deliveryWindow: "Ready within 8 days",
    summary: "Cold-pressed red palm oil prepared for local food processors pending verification.",
    imageClass: "bg-[linear-gradient(135deg,#6B3E1F,#D8903C)]",
    specs: [
      { label: "Extraction", value: "Cold-pressed" },
      { label: "Packaging", value: "20 L jerrycans" },
      { label: "MOQ", value: "80 L" },
      { label: "Inspection", value: "Pending" },
    ],
  },
  {
    ...
    crop: "Export Banana",
    quantity: "10 tonnes",
    quantityLabel: "10 tonnes available",
    ...
    farmerId: "jean-ngum",
    grade: "Export Grade A",
    deliveryWindow: "Ready within 10 days",
    summary: "Export-grade bananas prepared for Douala consolidation with cold-chain coordination.",
    imageClass: "bg-[linear-gradient(135deg,#7AA645,#E6C95A)]",
    specs: [
      { label: "Certification", value: "GlobalG.A.P. ready" },
      { label: "Packaging", value: "18 kg export cartons" },
      { label: "MOQ", value: "2 tonnes" },
      { label: "Shipping", value: "Douala consolidation" },
    ],
  },
];
