...
router.post('/:id/assign', validate(assignShipmentSchema), assignShipment);
router.post('/:id/positions', validate(updateShipmentPositionSchema), updateShipmentPosition);
router.patch('/:id/status', validate(updateShipmentStatusSchema), updateShipmentStatus);
